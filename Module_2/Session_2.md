...
First try to type:
```sh
less ~/module2/raw_data/chr_10/RD70_chr10.bam
```
...
```sh
samtools view -H ~/module2/raw_data/chr_10/RD70_chr10.bam | head -20
```
...
```sh
samtools view ~/module2/raw_data/chr_10/RD70_chr10.bam | head -1
```
...
```sh
samtools tview ~/module2/raw_data/chr_10/RD70_chr10.bam -p 10:21100
```
...
```sh
head -1 ~/module2/raw_data/sub_RD56_1.fastq
```
...
```sh
ls ~/module2/fastqs/*pair1.truncated > ./lists/r1.txt
ls ~/module2/fastqs/*pair2.truncated > ./lists/r2.txt
